#BIUE X DIAMOND(NXT BIUE X DIAMOND YT)(MD BIUE X DIAMOND.ISLAM)
#WhatsApp : 01327084556
#Github : BIUE X DIAMOND
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By BIUE X DIAMOND")
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/BIUE X DIAMOND/PAID/blob/main/PAID.txt').text
...
\033[1;33m╔═══════════════════════════════════════════════╗
║\033[1;32m🌺WELLCOME TO BIUE X DIAMOND WORLD 2.0🌺\033[1;33m║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[33;1m║ ╔═══════════════════════════════════════════╗ ║
\033[34;1m║ ║❤︎[❥] T𝐎O𝐋 NAME: \033[31;1m\033[32;1m BD R1NDOM                ║ ║
\033[35;1m║ ║❤︎[❥] A𝐔𝐓𝐇𝐎𝐑   : \033[32;1m\033[33;1m BIUE X DIAMOND  	║ ║
\033[36;1m║ ║❤︎[❥] G𝐈𝐓𝐇𝐔𝐁   : \033[33;1m\033[34;1m BIUE X DIAMOND     	   ║ ║
\033[35;1m║ ║❤︎[❥] WP       : \033[32;1m\033[33;1m +88019👿👿👿👿👿     ║  ║
\033[37;1m║ ║❤︎[❥] F𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : \033[34;1m BIUE X DIAMOND     			║ ║
\033[38;1m║ ║❤︎[❥] STATUS   : \033[33;1m\033[32;1m PREMIUM            	     ║ ║
...
def Main():
	...
	print("[2] BD Number cloner [FIRE]")
	print("[3] BD Number cloner [FIRE-V4] ")
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801936618364');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/BLUEXDIAMON/');time.sleep(1)
		admin()
	if bal =='3':
